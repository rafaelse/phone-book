...
Phone.create(ddr: "3209 3315", ramal: "3315", person_id: andressa.id, division_id: cf.id)
Phone.create(ddr: "3209 3315", ramal: "3315", person_id: andressa.id, division_id: drh.id)
Phone.create(ddr: "3209 3309", ramal: "3309", person_id: silvia.id, division_id: cec.id)
Phone.create(ddr: "3209 3309", ramal: "3309", person_id: silvia.id, division_id: material.id)
Phone.create(ddr: "3209 3309", ramal: "3309", person_id: silvia.id, division_id: patrimonio.id)
Phone.create(ddr: "3209 3309", ramal: "3309", person_id: silvia.id, division_id: ag.id)
Phone.create(ddr: "3209 3314", ramal: "3314", person_id: ivana.id, division_id: protocolo.id)
Phone.create(ddr: "3209 3314", ramal: "3314", person_id: ivana.id, division_id: arq_geral.id)
Phone.create(ddr: "3209 3314", ramal: "3339", person_id: renata.id, division_id: sp.id)
