...
Phone.create(ddr: 1632093313, branch:  3313, person_id: gustavo.id, division_id: manut.id)
Phone.create(ddr: 1632093313, branch:  3313, person_id: morita.id, division_id: manut.id)
Phone.create(ddr: 1632093313, branch:  3313, person_id: higor.id, division_id: manut.id)
Phone.create(ddr: 1632093372, branch:  3372, person_id: rafael.id, division_id: programacao.id)
Phone.create(ddr: 1632093372, branch:  3372, person_id: renato.id, division_id: programacao.id)
Phone.create(ddr: 1632093372, branch:  3372, person_id: lucas.id, division_id: programacao.id)
Phone.create( branch:  3340, person_id: christiano.id, division_id: infra.id)
Phone.create(ddr: 1632093315, branch:  3315, person_id: andressa.id, division_id: cf.id)
Phone.create(ddr: 1632093315, branch:  3315, person_id: andressa.id, division_id: drh.id)
Phone.create(ddr: 1632093309, branch:  3309, person_id: silvia.id, division_id: cec.id)
Phone.create(ddr: 1632093309, branch:  3309, person_id: silvia.id, division_id: material.id)
Phone.create(ddr: 1632093309, branch:  3309, person_id: silvia.id, division_id: patrimonio.id)
Phone.create(ddr: 1632093309, branch:  3309, person_id: silvia.id, division_id: ag.id)
Phone.create(ddr: 1632093314, branch:  3314, person_id: ivana.id, division_id: protocolo.id)
Phone.create(ddr: 1632093314, branch:  3314, person_id: ivana.id, division_id: arq_geral.id)
Phone.create(ddr: 1632093314, branch:  3339, person_id: renata.id, division_id: sp.id)
