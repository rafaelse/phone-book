...
Phone.create(ddr: "(16) 3209 3313", ramal: "3313", person_id: gustavo.id, division_id: manut.id)
Phone.create(ddr: "(16) 3209 3313", ramal: "3313", person_id: morita.id, division_id: manut.id)
Phone.create(ddr: "(16) 3209 3313", ramal: "3313", person_id: higor.id, division_id: manut.id)
Phone.create(ddr: "(16) 3209 3372", ramal: "3372", person_id: rafael.id, division_id: programacao.id)
Phone.create(ddr: "(16) 3209 3372", ramal: "3372", person_id: renato.id, division_id: programacao.id)
Phone.create(ddr: "(16) 3209 3372", ramal: "3372", person_id: lucas.id, division_id: programacao.id)
Phone.create(ddr: "", ramal: "3340", person_id: christiano.id, division_id: infra.id)
Phone.create(ddr: "(16) 3209 3315", ramal: "3315", person_id: andressa.id, division_id: cf.id)
Phone.create(ddr: "(16) 3209 3315", ramal: "3315", person_id: andressa.id, division_id: drh.id)
Phone.create(ddr: "(16) 3209 3309", ramal: "3309", person_id: silvia.id, division_id: cec.id)
Phone.create(ddr: "(16) 3209 3309", ramal: "3309", person_id: silvia.id, division_id: material.id)
Phone.create(ddr: "(16) 3209 3309", ramal: "3309", person_id: silvia.id, division_id: patrimonio.id)
Phone.create(ddr: "(16) 3209 3309", ramal: "3309", person_id: silvia.id, division_id: ag.id)
