...
ActiveRecord::Schema.define(version: 20171024182314) do
  ...
  create_table "divisions_phones", force: :cascade do |t|
    t.bigint "phone_id"
    t.bigint "division_id"
    t.index ["division_id"], name: "index_divisions_phones_on_division_id"
    t.index ["phone_id"], name: "index_divisions_phones_on_phone_id"
  end
  ...
  create_table "people_phones", force: :cascade do |t|
    t.bigint "phone_id"
    t.bigint "person_id"
